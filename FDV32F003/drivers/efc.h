...
#define EFC_OPR_OPRMODE_RSV			(1 << 0)
...
#define IS_EFC_MEM_ADDR(ADDRESS)                                                                                       \
	((((ADDRESS) >= 0x00002000) && ((ADDRESS) < 0x00006000)) ||                                                        \
	 (((ADDRESS) >= 0x00006000) && ((ADDRESS) < 0x00006800)) ||                                                        \
	 (((ADDRESS) >= 0x00007000) && ((ADDRESS) < 0x00007100)))
/**
  * @}
  */
...
#define IS_EFC_EEPROM_ADDR(ADDRESS) (((ADDRESS) >= 0x00007000) && ((ADDRESS) < 0x00007100))
