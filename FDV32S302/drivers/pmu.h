...
#define PMU_IT_ALL                                                                                                     \
	(PMU_IT_TWCWK | PMU_IT_GP19WK | PMU_IT_GP18WK | PMU_IT_GP17WK | PMU_IT_GP16WK | PMU_IT_LPTWK | PMU_IT_WDTWK |      \
	 PMU_IT_PORRST | PMU_IT_SOFTDIGRST | PMU_IT_SOFTCHIPRST | PMU_IT_EXTRST | PMU_IT_WDTRST | PMU_IT_LVDRST)

#define IS_PMU_CONFIG_IT(IT) (((IT)&PMU_IT_ALL) && (!((IT) & (~(PMU_IT_ALL)))))

#define IS_PMU_GET_IT(IT)                                                                                              \
	(((IT) == PMU_IT_TWCWK) || ((IT) == PMU_IT_GP19WK) || ((IT) == PMU_IT_GP18WK) || ((IT) == PMU_IT_GP17WK) ||       \
	 ((IT) == PMU_IT_GP16WK) || ((IT) == PMU_IT_LPTWK) || ((IT) == PMU_IT_WDTWK) || ((IT) == PMU_IT_PORRST) ||        \
	 ((IT) == PMU_IT_SOFTDIGRST) || ((IT) == PMU_IT_SOFTCHIPRST) || ((IT) == PMU_IT_EXTRST) ||                         \
	 ((IT) == PMU_IT_WDTRST) || ((IT) == PMU_IT_LVDRST))
/**
  * @}
  */
...
#define PMU_FLAG_ATCTIVESTS	 BIT(15)
...
#define PMU_FLAG_ALL                                                                                                   \
	(PMU_FLAG_TWCWK | PMU_FLAG_GP19WK | PMU_FLAG_GP18WK | PMU_FLAG_GP17WK | PMU_FLAG_GP16WK | PMU_FLAG_LPTWK |         \
	 PMU_FLAG_WDTWK | PMU_FLAG_PORRST | PMU_FLAG_SOFTDIGRST | PMU_FLAG_SOFTCHIPRST | PMU_FLAG_EXTRST |                 \
	 PMU_FLAG_WDTRST | PMU_FLAG_LVDRST)

#define IS_PMU_GET_FLAG(FLAG)                                                                                          \
	(((FLAG) == PMU_FLAG_ATCTIVESTS) || ((FLAG) == PMU_FLAG_TWCWK) || ((FLAG) == PMU_FLAG_GP19WK) ||                  \
	 ((FLAG) == PMU_FLAG_GP18WK) || ((FLAG) == PMU_FLAG_GP17WK) || ((FLAG) == PMU_FLAG_GP16WK) ||                      \
	 ((FLAG) == PMU_FLAG_LPTWK) || ((FLAG) == PMU_FLAG_WDTWK) || ((FLAG) == PMU_FLAG_PORRST) ||                        \
	 ((FLAG) == PMU_FLAG_SOFTDIGRST) || ((FLAG) == PMU_FLAG_SOFTCHIPRST) || ((FLAG) == PMU_FLAG_EXTRST) ||            \
	 ((FLAG) == PMU_FLAG_WDTRST) || ((FLAG) == PMU_FLAG_LVDRST))
