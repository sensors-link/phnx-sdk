...
void SystemInit(void)
{
    ...
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V0;
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V1;
    SYSC_CLKCTRCFG_REG |=  (((SYSC_APB_DIV)<<SYSC_CLKCTRCFG_AHB_CLK_DIV_pos) | ((SYSC_AHB_DIV)<<SYSC_CLKCTRCFG_AHB_CLK_DIV_pos) | SYSC_CLKCTRCFG_SYS_CLK_SEL_XTH);
    ...
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V0;
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V1;
	SYSC_CLKCTRCFG_REG |=  (((SYSC_APB_DIV)<<SYSC_CLKCTRCFG_AHB_CLK_DIV_pos) | ((SYSC_AHB_DIV)<<SYSC_CLKCTRCFG_AHB_CLK_DIV_pos) | SYSC_CLKCTRCFG_SYS_CLK_SEL_XTL);
    ...
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V0;
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V1;
	SYSC_CLKCTRCFG_REG |=  (((SYSC_APB_DIV)<<SYSC_CLKCTRCFG_AHB_CLK_DIV_pos) | ((SYSC_AHB_DIV)<<SYSC_CLKCTRCFG_AHB_CLK_DIV_pos) | SYSC_CLKCTRCFG_SYS_CLK_SEL_LRC );
#else
    SYSC_CLKENCFG_REG |= SYSC_CLKENCFG_ANAC;
	ANAC_WPROT_REG = ANAC_WPROT_V0;
    ANAC_WPROT_REG = ANAC_WPROT_V1;
    ...
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V0;
    SYSC_WRPROCFG_REG = SYSC_WRPROCFG_V1;
	SYSC_CLKCTRCFG_REG |=  (((SYSC_APB_DIV)<<SYSC_CLKCTRCFG_APB_CLK_DIV_pos) | ((SYSC_AHB_DIV)<<SYSC_CLKCTRCFG_AHB_CLK_DIV_pos) | SYSC_CLKCTRCFG_SYS_CLK_SEL_HRC );
#endif
