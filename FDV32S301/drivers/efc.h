...
#define EFC_OPR_OPRMODE_ROW_PRG	   (1 << 0)
#define EFC_OPR_OPRMODE_PAGE_ERASE (2 << 0)
#define EFC_OPR_OPRMODE_CHIP_ERASE (3 << 0)
#define EFC_OPR_OPRMODE_PAGE_LOAD  (4 << 0)
#define EFC_OPR_OPRMODE_PE_VERIFY  (5 << 0)
#define EFC_OPR_OPRMODE_PP_VERIFY  (6 << 0)
...
#define EFC_PVEV_EVCNT_pos (8)
#define EFC_PVEV_PVCNT_pos (0)
...
/**
  * @defgroup EFC_Normal_Read_Cycle
  * @{
  */

#define EFC_NRDDLY_0		  (0)
#define EFC_NRDDLY_1		  (1)
#define IS_EFC_NRDDLY(NRDDLY) (((NRDDLY) == EFC_NRDDLY_0) || ((NRDDLY) == EFC_NRDDLY_1))
/**
  * @}
  */

/**
  * @defgroup EFC_Verify_Read_Type
  * @{
  */

#define EFC_VERIFY_TYPE_ERASE (0)
#define EFC_VERIFY_TYPE_PRG	  (1)

#define IS_EFC_VERIFY_TYPE(TYPE) (((TYPE) == EFC_VERIFY_TYPE_ERASE) || ((TYPE) == EFC_VERIFY_TYPE_PRG))
/**
  * @}
  */
...
#define EFC_OPR_MODE_ROW_PRG	(1)
#define EFC_OPR_MODE_PAGE_ERASE (2)
#define EFC_OPR_MODE_CHIP_ERASE (3)
#define EFC_OPR_MODE_PAGE_LOAD	(4)
#define EFC_OPR_MODE_PE_VERIFY	(5)
#define EFC_OPR_MODE_PP_VERIFY	(6)

#define IS_EFC_OPR_MODE(MODE)                                                                                          \
	(((MODE) == EFC_OPR_MODE_SIG_PRG) || ((MODE) == EFC_OPR_MODE_ROW_PRG) || ((MODE) == EFC_OPR_MODE_PAGE_ERASE) ||    \
	 ((MODE) == EFC_OPR_MODE_CHIP_ERASE) || ((MODE) == EFC_OPR_MODE_PAGE_LOAD) ||                                      \
	 ((MODE) == EFC_OPR_MODE_PE_VERIFY) || ((MODE) == EFC_OPR_MODE_PP_VERIFY))
/**
  * @}
  */
...
#define EFC_IT_EVE	 BIT(3)
#define EFC_IT_PVE	 BIT(2)
#define EFC_IT_FCE	 BIT(1)
#define EFC_IT_CD	 BIT(0)

#define EFC_IT_ALL                                                                                                     \
	(EFC_IT_ATDE | EFC_IT_ATTE | EFC_IT_FTTE | EFC_IT_ADDRE | EFC_IT_EVE | EFC_IT_PVE | EFC_IT_FCE | EFC_IT_CD)
...
#define IS_EFC_GET_IT(IT)                                                                                              \
	(((IT) == EFC_IT_ATDE) || ((IT) == EFC_IT_ATTE) || ((IT) == EFC_IT_FTTE) || ((IT) == EFC_IT_ADDRE) ||              \
	 ((IT) == EFC_IT_EVE) || ((IT) == EFC_IT_PVE) || ((IT) == EFC_IT_FCE) || ((IT) == EFC_IT_CD))
/**
  * @}
  */
...
#define EFC_FLAG_EVE   BIT(3)
#define EFC_FLAG_PVE   BIT(2)
#define EFC_FLAG_FCE   BIT(1)
#define EFC_FLAG_CD	   BIT(0)

#define EFC_FLAG_ALL                                                                                                   \
	(EFC_FLAG_ATDE | EFC_FLAG_ATTE | EFC_FLAG_FTTE | EFC_FLAG_ADDRE | EFC_FLAG_EVE | EFC_FLAG_PVE | EFC_FLAG_FCE |     \
	 EFC_FLAG_CD)

#define IS_EFC_GET_FLAG(FLAG)                                                                                          \
	(((FLAG) == EFC_FLAG_ATDE) || ((FLAG) == EFC_FLAG_ATTE) || ((FLAG) == EFC_FLAG_FTTE) ||                            \
	 ((FLAG) == EFC_FLAG_ADDRE) || ((FLAG) == EFC_FLAG_EVE) || ((FLAG) == EFC_FLAG_PVE) || ((FLAG) == EFC_FLAG_FCE) || \
	 ((FLAG) == EFC_FLAG_CD))
...
#define IS_EFC_MEM_ADDR(ADDRESS)                                                                                       \
	((((ADDRESS) >= 0x10100000) && ((ADDRESS) < 0x10120000)) ||                                                        \
	 (((ADDRESS) >= 0x10140000) && ((ADDRESS) < 0x10140E00)) ||                                                        \
	 (((ADDRESS) >= 0x10180000) && ((ADDRESS) < 0x10180400)))
/**
  * @}
  */

/**
  * @defgroup EFC_page_programming_address
  * @{
  */

#define IS_PAGE_PRG_ADDR(ADDRESS)                                                                                      \
	((((ADDRESS) >= 0x10100000) && ((ADDRESS) < 0x10120000)) || (((ADDRESS) >= 0x10140000) && ((ADDRESS) < 0x10140E00)))
...
#define IS_EFC_EEPROM_ADDR(ADDRESS) (((ADDRESS) >= 0x10180000) && ((ADDRESS) < 0x10180400))
