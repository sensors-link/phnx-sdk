...
#define GPIO_ALL                                                                                                       \
	(GPIO_PIN0 | GPIO_PIN1 | GPIO_PIN2 | GPIO_PIN3 | GPIO_PIN4 | GPIO_PIN5 | GPIO_PIN6 | GPIO_PIN7 | GPIO_PIN8 |       \
	 ...
	 GPIO_PIN17 | GPIO_PIN18 | GPIO_PIN19)
...
#define IOM_ALT_FUNC_P00_SEL_SPI_CS	   IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P00_SEL_TIM3_GATE IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P01_SEL_GPIO	  IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P01_SEL_UART1_TX IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P01_SEL_SPI_SCK  IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P01_SEL_TIM3_EXT IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P02_SEL_GPIO	  IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P02_SEL_UART2_RX IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P02_SEL_SPI_MOSI IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P02_SEL_XTHI	  IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P03_SEL_GPIO	  IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P03_SEL_UART2_TX IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P03_SEL_SPI_MISO IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P03_SEL_XTHO	  IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P04_SEL_GPIO	  IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P04_SEL_JTAG_TCK IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P04_SEL_UART2_RX IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P04_SEL_TIM2_TOG IOM_ALT_FUNC_3
...
#define IOM_ALT_FUNC_P05_SEL_TIM2_TOGN IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P06_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P06_SEL_JTAG_TMS  IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P06_SEL_TIM4_GATE IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P06_SEL_TIM4_TOG  IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P07_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P07_SEL_JTAG_TDO  IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P07_SEL_TIM4_EXT  IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P07_SEL_TIM4_TOGN IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P08_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P08_SEL_TIM1_TOG  IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P08_SEL_TIM1_GATE IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P08_SEL_RTC_1HZ   IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P09_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P09_SEL_TIM1_TOGN IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P09_SEL_TIM1_EXT  IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P09_SEL_XTL_1HZ   IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P10_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P10_SEL_TIM2_TOG  IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P10_SEL_TIM2_GATE IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P10_SEL_TWC_RX	   IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P11_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P11_SEL_TIM2_TOGN IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P11_SEL_TIM2_EXT  IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P11_SEL_TWC_TX	   IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P12_SEL_GPIO	 IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P12_SEL_SPI_CS	 IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P12_SEL_I2C_SDA IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P12_SEL_TSTO	 IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P13_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P13_SEL_SPI_SCK   IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P13_SEL_I2C_SCL   IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P13_SEL_TIM3_TOGN IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P14_SEL_GPIO	  IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P14_SEL_SPI_MOSI IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P14_SEL_TIM3_TOG IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P14_SEL_UART2_RX IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P15_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P15_SEL_SPI_MISO  IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P15_SEL_TIM3_TOGN IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P15_SEL_UART2_TX  IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P16_SEL_GPIO	  IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P16_SEL_TIM3_TOG IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P16_SEL_UART1_RX IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P16_SEL_SPI_MOSI IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P17_SEL_GPIO	  IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P17_SEL_TSTO	  IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P17_SEL_UART1_TX IOM_ALT_FUNC_2
...
#define IOM_ALT_FUNC_P18_SEL_LPUART_RX IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P18_SEL_SPI_SCK   IOM_ALT_FUNC_3

#define IOM_ALT_FUNC_P19_SEL_GPIO	   IOM_ALT_FUNC_0
#define IOM_ALT_FUNC_P19_SEL_TWC_TX	   IOM_ALT_FUNC_1
#define IOM_ALT_FUNC_P19_SEL_LPUART_TX IOM_ALT_FUNC_2
#define IOM_ALT_FUNC_P19_SEL_SPI_CS	   IOM_ALT_FUNC_3
