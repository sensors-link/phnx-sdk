...
void SPI_Init(int pin,int mode,int pol,int phase,int freq)
{
    ...
    if( pin == SPI_PIN_0_1_2_3)
    {
        ...
        IOM->AF0 |= (IOM_AF0_P00_SEL_SPI_CS | IOM_AF0_P01_SEL_SPI_SCK | IOM_AF0_P02_SEL_SPI_MOSI | IOM_AF0_P03_SEL_SPI_MISO);
    }
    else if( pin == SPI_PIN_12_13_14_15)
    {
        IOM->AF0 &= ~(IOM_AF0_P12_SEL | IOM_AF0_P13_SEL | IOM_AF0_P14_SEL | IOM_AF0_P15_SEL);
        IOM->AF0 |= (IOM_AF0_P12_SEL_SPI_CS | IOM_AF0_P13_SEL_SPI_SCK | IOM_AF0_P14_SEL_SPI_MOSI | IOM_AF0_P15_SEL_SPI_MISO);
    }
    else
    {
        IOM->AF1 &= ~(IOM_AF1_P19_SEL | IOM_AF1_P18_SEL | IOM_AF1_P16_SEL | IOM_AF1_P17_SEL);
        IOM->AF1 |= (IOM_AF1_P19_SEL_SPI_CS | IOM_AF1_P18_SEL_SPI_SCK | IOM_AF1_P16_SEL_SPI_MOSI | IOM_AF1_P17_SEL_SPI_MISO);
    }
