 ...
 * @param iWKPinEn : PMU_WK_PIN16 [| PMU_WK_PIN17 | PMU_WK_PIN18 | PMU_WK_PIN19] surp,t '|' combination
 *
 */
 ...
 *
 * note：the successive powerdown/deepsleep interval should be more than 2ms at least
 */
