...
#define WDT_StartCount()         {WDT_RST_REG = WDT_START_RST_V0;WDT_RST_REG = WDT_START_RST_V1;}
#define WDT_ClrCount()           {WDT_RST_REG = WDT_START_RST_V0;WDT_RST_REG = WDT_START_RST_V1;}
#define WDT_ClrIntFlag()         {WDT_RST_REG = WDT_START_RST_V0;WDT_RST_REG = WDT_START_RST_V1;}
