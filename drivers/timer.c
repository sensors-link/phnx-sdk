 ...
 * @param portSel :TIM1_CNT_PORT_P8_P9 , TIM2_CNT_PORT_P10_P11 , TIM3_CNT_PORT_P6_P7
 */
...
void TIM_PWMInit(TIM_Type *pTim,int pwmPolarity,int freq,int duty,int portSel,int dtGap)
{
    ...
    if( pTim == TIM1)
    {
        ...
        PARAM_CHECK( (pwmPolarity != TIM_PWM_POL_PWM0_PWM1) && (pwmPolarity != TIM_PWM_POL_PWM0_NPWM1) && (pwmPolarity != TIM_PWM_POL_NPWM0_PWM1) && (pwmPolarity != TIM_PWM_POL_NPWM0_NPWM1));
