...
#define SYSC_WPT_UNLOCK()         {SYSC->WRPROCFG = 0x5a5a;SYSC->WRPROCFG = 0xa5a5;}
...
#define   SYSC_GetAPBCLK()     (SystemCoreClock/(((SYSC->CLKCTRCFG&SYSC_CLKCTRCFG_APB_CLK_DIV)>>SYSC_CLKCTRCFG_APB_CLK_DIV_pos)+1)/(((SYSC->CLKCTRCFG&SYSC_CLKCTRCFG_AHB_CLK_DIV)>>SYSC_CLKCTRCFG_AHB_CLK_DIV_pos)+1))
#define   SYSC_GetAHBCLK()     (SystemCoreClock/(((SYSC->CLKCTRCFG&SYSC_CLKCTRCFG_AHB_CLK_DIV)>>SYSC_CLKCTRCFG_AHB_CLK_DIV_pos)+1))
