...
#define ANAC_PDSENS_CFG_GC           BITS(0,6)
...
#define ANAC_CMP_CFG_VINSEL_VBGS      (7<<5)
#define ANAC_CMP_CFG_VINSEL_VBGA      (6<<5)
#define ANAC_CMP_CFG_VINSEL_V1P5S     (5<<5)
...
#define ANAC_CMP_CFG_VIPSEL_VC1P6   (6<<2)
...
#define ANAC_ADC_CFG_VOLTREF_VRSEL_2P5     (2<<1)
#define ANAC_ADC_CFG_VOLTREF_VRSEL_4P3     (3<<1)
...
#define ANAC_ANAC_CFG_ALDO4A_VOSEL_1P2    (1<<8)
#define ANAC_ANAC_CFG_ALDO4A_VOSEL_1P0    (2<<8)
#define ANAC_ANAC_CFG_ALDO4A_VOSEL_0P8    (3<<8)
...
//ANAC_AINSEL
#define ANAC_AINSEL_GPIO3_SEL_VC1P6     (1<<3)
#define ANAC_AINSEL_GPIO5_SEL_VC1P6     (1<<5)
#define ANAC_AINSEL_GPIO7_SEL_VC1N2     (1<<7)
#define ANAC_AINSEL_GPIO11_SEL_VC1N0    (1<<11)
#define ANAC_AINSEL_GPIO12_SEL_VC1P2    (1<<12)
#define ANAC_AINSEL_GPIO13_SEL_VC1P3    (1<<13)
#define ANAC_AINSEL_GPIO14_SEL_VC1P4    (1<<14)
#define ANAC_AINSEL_GPIO15_SEL_VC1P5    (1<<15)
#define ANAC_AINSEL_GPIO16_SEL_LVDI0    (1<<16)
#define ANAC_AINSEL_GPIO17_SEL_PDTST    (1<<17)
#define ANAC_AINSEL_GPIO18_SEL_VPTST    (1<<18)
#define ANAC_AINSEL_GPIO19_SEL_LVDI1    (1<<19)
...
#define ANAC_WPT_UNLOCK()     {ANAC->WPROT = 0x5a5a;ANAC->WPROT = 0xa5a5;}
